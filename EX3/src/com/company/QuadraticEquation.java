...
public class QuadraticEquation {
    public static void main(String[] args) throws IOException {
        ...
        if (a == 0) {
            ...
            System.out.println("Enter value of b(and press enter");
            ...
            switch (rootsNumber) {
                ...
                case 1: {
                    ...
                    System.out.printf("For a=" + "%4.2f,", b);
                    System.out.printf("For a=" + "%4.2f,", c);
                    System.out.print("the trinomial ahs one double root=");
